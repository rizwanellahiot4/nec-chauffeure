    ...
    <div className="min-h-screen flex flex-col">
      ...
      <section className="hero-gradient py-16 sm:py-24">
        <div className="container text-center">
          <motion.h1 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="font-display text-3xl sm:text-5xl font-bold text-primary-foreground mb-4">
          ...
          <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="text-primary-foreground/70 text-lg max-w-2xl mx-auto">
            {brand?.businessName ?? 'EliteDrive'} delivers luxury airport transfers, hourly chauffeurs, private tours, and one-way rides.
          </motion.p>
        </div>
      </section>
